...
//    private WxOpenConfig wxOpenConfig;
     ...
     */
    @PostMapping("/login")
    public BaseLoginResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
