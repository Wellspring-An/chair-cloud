package com.chair.app.controller;
...
import com.chair.app.model.dto.question.*;
import com.chair.app.model.entity.App;
import com.chair.app.model.entity.Question;
import com.chair.app.model.enums.AppTypeEnum;
import com.chair.app.model.vo.QuestionVO;
import com.chair.app.service.AppService;
import com.chair.app.service.QuestionService;
import com.chair.auth.annotation.AuthCheck;
import com.chair.auth.common.BaseResponse;
import com.chair.auth.common.DeleteRequest;
import com.chair.auth.common.ErrorCode;
import com.chair.auth.common.ResultUtils;
import com.chair.auth.constant.UserConstant;
...
public class QuestionController {
    ...
    @Resource
    private AuthAppFeignClient authFeignClient;

    @Resource
    private AppService appService;

    @Resource
    private AiAppFeignClient aiFeignClient;
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        // todo 填充默认值
        LoginUserVO loginUser = (LoginUserVO) authFeignClient.getLoginUser(request.getHeader("chair-token")).getData();
    ...
    public BaseResponse<Boolean> deleteQuestion(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldQuestion.getUserId().equals(loginUser.getId()) && !UserRoleEnum.ADMIN.getValue().equals(loginUser.getUserRole())) {
    ...
    private static final String GENERATE_QUESTION_SYSTEM_MESSAGE = "你是一位严谨的出题专家，我会给你如下信息：\n" +
            ...
            "\n" +
            "请你根据上述信息，按照以下步骤来出题：\n" +
            "1. 要求：题目不要包含序号，每题的选项数严格按照我提供的数据，题目不能重复，生成的题目不要跟应用名称类似，测试题目跟选项不要有我给你的信息\n" +
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(
        ...
        // AI 生成
        String result = aiFeignClient.simpleChat(appId + "-" + redisTemplate.opsForValue().get("chair-token"), userMessage, GENERATE_QUESTION_SYSTEM_MESSAGE);
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest, HttpServletRequest request) {
        ...
        // AI 生成，SSE 流式返回
        Flux<String> stringFlowable = aiFeignClient.simpleChatSSE(appId + "-" + redisTemplate.opsForValue().get("chair-token"), userMessage, GENERATE_QUESTION_SYSTEM_MESSAGE);
...
//    }
    ...
    public Flux<String> askQuestionSSE(String question, HttpServletRequest request) {
        return aiFeignClient.simpleChatSSE("chatStream", question, "你是聊天问答客服，请回答用户的所有问题，输出格式为html，输出的文章要整洁好看，在之上的基础上要遵从写文章的格式，以下标点(，。：,.:)要在后边加<br>");
    }

    @GetMapping("/ai_generate/bd")
    public String askQuestion(String question, HttpServletRequest request) {
        return aiFeignClient.simpleChat("chat", question, GENERATE_QUESTION_SYSTEM_MESSAGE);
    }
}
