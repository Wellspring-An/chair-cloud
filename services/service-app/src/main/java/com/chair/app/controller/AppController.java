...
import com.chair.app.model.dto.app.AppAddRequest;
import com.chair.app.model.dto.app.AppEditRequest;
import com.chair.app.model.dto.app.AppQueryRequest;
import com.chair.app.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> deleteApp(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        LoginUserVO user = (LoginUserVO) authFeignClient.getLoginUser(request.getHeader("chair-token")).getData();
        long id = deleteRequest.getId();
        // 判断是否存在
        App oldApp = appService.getById(id);
        ThrowUtils.throwIf(oldApp == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可删除
        if (!oldApp.getUserId().equals(user.getId()) && !UserRoleEnum.ADMIN.getValue().equals(user.getUserRole())) {
