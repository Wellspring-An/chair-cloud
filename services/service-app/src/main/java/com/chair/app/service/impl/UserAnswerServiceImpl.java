...
import com.chair.app.mapper.UserAnswerMapper;
import com.chair.app.model.dto.userAnswer.UserAnswerQueryRequest;
import com.chair.app.model.entity.App;
import com.chair.app.model.entity.UserAnswer;
import com.chair.app.model.vo.UserAnswerVO;
import com.chair.app.service.AppService;
import com.chair.app.service.UserAnswerService;
...
//        String choices = userAnswer.getChoices();
        ...
        if (add) {
            // 补充校验规则
            ThrowUtils.throwIf(ObjectUtils.isEmpty(appId), ErrorCode.PARAMS_ERROR, "appId 非法");
            ThrowUtils.throwIf(ObjectUtils.isEmpty(id), ErrorCode.PARAMS_ERROR, "id 非法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        if (appId != null) {
...
//        }
    ...
    public Page<UserAnswerVO> getUserAnswerVOPage(Page<UserAnswer> userAnswerPage, HttpServletRequest request) {
        ...
        // 填充信息
        userAnswerVOList.forEach(appVO -> {
